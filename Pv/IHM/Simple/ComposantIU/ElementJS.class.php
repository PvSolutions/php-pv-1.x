<?php
	...
	bloc'.$this->IDInstanceCalc.'.UtiliserContenuBrutContenuCorps = true ;
	bloc'.$this->IDInstanceCalc.'.ContenuBrutContenuCorps = '.svc_json_encode($HTTP_RAW_POST_DATA).' ;
	bloc'.$this->IDInstanceCalc.'.DefinitUrl('.svc_json_encode($this->ActionRecupContenuHtml->ObtientUrl()).') ;
