<?php
	...
	if(! defined('PV_COMPOSANT_BS_ADMIN_DIRECTE'))
	{
		...
		define('PV_COMPOSANT_BS_ADMIN_DIRECTE', 1) ;
		...
		class PvCommandeOuvreOngletBsAdminDirecte extends PvCommandeRedirectionHttp
		{
			// public $FeneParent
			public $IdOnglet = "" ;
			public $TitreOnglet = "" ;
	...
	jQuery(function() {
		...
		class PvCmdFermeOngletActifBsAdminDirecte extends PvCommandeOuvreOngletBsAdminDirecte
		{
			public $NomFoncConteneur = "fermeOngletActif" ;
			public $AccepteArgsFonc = 0 ;
		}
		class PvCmdFermeFenetreActiveBsAdminDirecte extends PvCommandeOuvreOngletBsAdminDirecte
		{
			public $NomFoncConteneur = "fermeFenetreActive" ;
			public $AccepteArgsFonc = 0 ;
		}
		class PvCommandeOuvreFenetreBsAdminDirecte extends PvCommandeOuvreOngletBsAdminDirecte
		{
			public $NomCadreConteneur = "parent" ;
		...
		class PvTableauDonneesBsAdminDirecte extends PvTableauDonneesBootstrap
		{
			...
			{
				return new PvCommandeOuvreOngletBsAdminDirecte() ;
			}
			...
			{
				return new PvCommandeOuvreFenetreBsAdminDirecte() ;
			}
