<?php
	...
	if(! defined('PV_METHODE_DISTANTE_NOYAU_IONIC'))
	{
		...
		class PvErreurResultDistantIonic
		{
			public $code = -1 ;
		...
		class PvResultDistantIonic
		{
			public $erreur ;
			public $valeur ;
			public function  __construct()
			{
				$this->erreur = new PvErreurResultDistantIonic() ;
			}
		...
		class PvMethodeDistanteNoyauIonic extends PvElemZoneIonic
		{
			protected $_Param ;
			protected $_Result ;
			...
			{
				parent::InitConfig() ;
				$this->ComposantIUParent = new PvComposantIUIndefIonic() ;
			}
			protected function CreeParam()
			{
				return new PvParamDistantIonic() ;
			}
			protected function CreeResult()
			{
				return new PvResultDistantIonic() ;
			}
		...
		class PvMtdDistNonTrouveeIonic extends PvMethodeDistanteNoyauIonic
		{
			protected function ExecuteInstructions()
			{
		...
		class PvMtdDistFormDonneesIonic extends PvMethodeDistanteNoyauIonic
		{
		...
		class PvMtdDistTablDonneesIonic extends PvMethodeDistanteNoyauIonic
		{
			public function PrepareExecution()
			{
				$this->ComposantIUParent->LieTousLesFiltres() ;
